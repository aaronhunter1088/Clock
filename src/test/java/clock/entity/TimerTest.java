...
//        assertSame(0, timer.getHours());
//        assertSame(5, timer.getMinutes());
//        assertSame(0, timer.getSeconds());
...
//        assertSame(3, timer1.getMinutes());
//        assertSame(58, timer1.getSeconds());
//
//        assertSame(0, timer2.getHours());
//        assertSame(4, timer2.getMinutes());
//        assertSame(55, timer2.getSeconds());
//    }
//
//    @Test
