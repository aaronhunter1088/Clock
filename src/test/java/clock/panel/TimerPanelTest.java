...
//        assertTrue(timerPanel.getMinuteField().isFocusOwner(), "Expected minutes field to have focus");
//        assertEquals(SET, timerPanel.getTimerButton().getText(), "Expected set timer button text to be "+SET);
//        assertFalse(timerPanel.getTimerButton().isEnabled(), "Expected set timer button to be disabled");
//    }
//
//}